...
| `Precios_PS03.xlsx` |  En la hoja "Estudiantes-target" contiene precios de propiedades de Santiago |
| `Precios_PS03.xlsx` |  En la hoja "Estudiantes‐train‐test" vienen datos de más de 10 mil propiedades |
---
## Autor
